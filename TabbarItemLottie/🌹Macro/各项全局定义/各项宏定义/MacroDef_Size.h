...
static inline CGFloat TabBarHeight(){
    //即时获取
    CGFloat tabBarHeight = TabbarItemLottieAppDelegate.sharedInstance.tabBarVC.tabBar.frame.size.height;
...
static inline CGFloat BottomSafeAreaHeight(){
    ...
    return TabBarHeight() - 49 - TabbarItemLottieAppDelegate.sharedInstance.tabBarVC.myTabBar.offsetHeight;
}
